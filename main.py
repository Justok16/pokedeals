...
def main() -> int:
    ...
    for carte in cfg["watchlist"]:
        ...
        if cote:
            ...
            # V34 : on regroupe par ALIAS quand il existe (c'est justement
            # ce qui relie "Dracaufeu" FR à "Charizard" JP/KR), sinon par le
            # nom de la carte lui-même.
            cle_regroupement = normaliser(carte.get("alias") or nom)
