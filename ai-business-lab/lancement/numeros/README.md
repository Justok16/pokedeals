# Les 6 premiers numéros — prêts à envoyer

Six numéros rédigés intégralement, dans la structure fixe arrêtée dans
[`../02-newsletter.md`](../02-newsletter.md) : objet, préheader, cinq blocs,
400-600 mots.

## À faire avant d'envoyer quoi que ce soit

1. **Vérifier chaque marqueur `[VÉRIFIER]`** sur sa source officielle. Les faits
   proviennent de sources secondaires spécialisées, collectées le 21/09/2026.
   Un fait non retrouvé en source officielle est **retiré**, pas atténué.
2. **Remplacer `[LIEN]`** par les liens réels, d'affiliation ou non.
